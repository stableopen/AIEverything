...
XLSX/PPTX parser code remains present but AIEverything 1.0.4 does not enqueue or
...
Legacy parser code can extract text-based PDFs. AIEverything 1.0.4's machine
