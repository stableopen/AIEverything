...
XLSX/PPTX parser code remains present but AIEverything 1.0.2 does not enqueue or
...
Legacy parser code can extract text-based PDFs. AIEverything 1.0.2's machine
